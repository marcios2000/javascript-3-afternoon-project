...
//Code Here
let evenNumbers  = mixedNumbers.filter(function(num, i, arr){
  return num % 2 === 0
})
...
//Code Here
let postTaxPrices  = prices.map(function(prices, i, arr){
  return prices * 1.07
});
...
//Code Here
let totalPopulation  = populations.reduce(function(total, element){
...
//Code Here
let myStrongest = monstersInYourPocket.filter(function(element, i, array){
  if( element > 200){
    return element
  }
})
